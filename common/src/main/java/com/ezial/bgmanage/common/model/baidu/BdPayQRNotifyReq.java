...
public class BdPayQRNotifyReq implements Serializable{
    private static final long serialVersionUID = -8515357294835662301L;
    ...
    private String bfb_order_create_time;//百度钱包交易创建时间 YYYYMMDDHHMMSS

    private String pay_time;//支付时间 YYYYMMDDHHMMSS

    private String pay_type;// 支付类型

    private String bank_no;//用于支付的银行编号

    private String unit_amount;//商品单价，以分为单位

    private String unit_count;//商品数量

    private String transport_amount;//运费，以分为单位

    private String total_amount;//总金额，以分为单位

    private String fee_amount;//百度钱包收取商户的手续费，以分为单位

    private String currency;//币种，目前仅支持人民币

    private String buyer_sp_username;//买家在商户网站的用户名

    private String pay_result;//支付结果代码 1 等待支付 2 支付成功 3 交易成功 10 支付失败

    private String input_charset;//请求参数的字符编码
