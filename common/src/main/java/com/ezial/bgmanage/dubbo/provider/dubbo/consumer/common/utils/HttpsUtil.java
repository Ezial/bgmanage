...
public class HttpsUtil {
   ...
   * @throws Exception
   */
  private static HttpsURLConnection initHttps(
      String url, String method, Map<String, String> headers) throws Exception {
    ...
    // 设置域名校验
    http.setHostnameVerifier(new HttpsUtil().new TrustAnyHostnameVerifier());
    // 连接超时
    http.setConnectTimeout(DEF_CONN_TIMEOUT);
    // 读取超时 --服务器响应比较慢，增大时间
    http.setReadTimeout(DEF_READ_TIMEOUT);
  ...
  public static void main(String[] args) {
      try {
        System.out.println(get("https://127.0.0.1:8443/say/tellmegod"));
      System.out.println(
          post("https://127.0.0.1:8443/say/testPost", "{\"id\":123}"));
      } catch (Exception e){
        e.printStackTrace();
      }
